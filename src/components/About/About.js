...
export default function About(props) {
  ...
  // });
  let myStyle = {
    color: props.mode === 'dark'?'white':'#0d94fd6b',
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              TextEditor gives you way to anaylize your text quickly and
              efficiently. Be it word count, character count or anything you
              need to anaylize your text.
            </div>
          </div>
        </div>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              ...
              suitable for writting text with words or character limit.
            </div>
          </div>
        </div>
        <div className="accordion-item">
